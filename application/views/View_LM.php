        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    <li class="xn-logo">
                        <a href="LM">Line Manager</a>
                        <a href="View_LM" class="x-navigation-control"></a>
                    </li>
                    <li class="xn-profile">
                        ...
                        <div class="col-md-12">
                         <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Halaman Line Manager</h3>
                                </div>
                                <div class="panel-body">
                                    <div class="col-sm-12">
                                <h4> Selamat Datang, pada halaman ini anda dapat melakukan berbagai hal terkait dengan hak Line Manager diantaranya : </h4> </div>
                                <div class="col-md-6">
